...
def get_recommended_modification(simple_order, impact):
    ...
    :param impact: whether the change has poitive or negative impact
...
def parse_explainations(exp_list):
    """
    Parse explanation returned by LIME into a user readable format
    :param exp_list: explanations returned by LIME explainer
    :return: array of dictionaries cotaining user facing strings
    """
    parsed_exps=[]
