...
from ml_editor.explananation_generation import (
    parse_explainations,
...
def get_features_from_text_array(input_array):
    """
    Generates features for an input array of text
...
def get_recommendation_and_prediction_from_text(input_text, num_feats=10):
    ...
    parsed_exps=parse_explainations(exp.as_list())
